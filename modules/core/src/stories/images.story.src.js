...
class Story extends React.Component {
  ...
  handleClick () {
    this.setState((state) => {
      state.pattern = (state.pattern === 'greenPattern')
        ? 'orangePattern'
        : 'greenPattern'
      return state
    })
    ...
    return (
      <MapGL {...mapDefaults}>
        <LoadImages
          ...
          orangePattern={require('./assets/orange-pattern.jpg')}
        >
          <Layer
            id='teams'
            type='symbol'
          ...
          <Layer
            ...
            paint={{
              'fill-pattern': this.state.pattern
            }}
          />
        </LoadImages>
        <Overlay>
          <button onClick={this.handleClick}>Switch Pattern</button>
        </Overlay>
      </MapGL>
    )
  }
